    ...
    <>
      ...
      <CollapseWrapper title="Когда использовать">
        ...
        <ul>
          ...
          <li>
            Компоненту передаются одинаковые параметры при нескольких ререндерах
          </li>
      ...
      <CardWrapper>
        <i className="bi bi-lightbulb"></i> Функциональный объект равен только
        самому себе
      </CardWrapper>
      <Divider />
      ...
      <CardWrapper>
        ...
        <CardWrapper>
          <i className="bi bi-lightbulb"></i> Если функция для сверки не задана,
          то выполняется поверхностная сверка по{' '}
          <Link
            to={{
              pathname:
